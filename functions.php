<?php
/**
 * Hetvi_Patel functions and definitions
 *
...
if ( ! function_exists( 'hetvi_patel_setup' ) ) :
	...
	function hetvi_patel_setup() {
		 ...
		 * If you're building a theme based on Hetvi_Patel, use a find and replace
		 * to change 'hetvi-patel' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'hetvi-patel', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'hetvi-patel' ),
		) );
...
function hetvi_patel_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'hetvi-patel' ),
...
function hetvi_patel_scripts() {
	...
	wp_enqueue_script( 'hetvi-patel-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
